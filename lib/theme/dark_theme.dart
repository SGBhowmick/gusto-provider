...
ThemeData dark = ThemeData(
  fontFamily: 'Roboto',
  // Updated to a slightly brighter green for dark mode visibility
  primaryColor: Color(0xFF07B89C),
  ...
  hoverColor: const Color(0xFF1B5E20), // Dark green hover
