import 'package:dusto_provider/common/widgets/circular_icon_button_widget.dart';
import 'package:dusto_provider/common/widgets/loading_overlay_widget.dart';
import 'package:dusto_provider/feature/booking_requests/controller/calendar_controller.dart';
import 'package:dusto_provider/feature/booking_requests/controller/calender_order_filter_controller.dart';
import 'package:dusto_provider/feature/booking_requests/model/booking_appointment_model.dart';
import 'package:dusto_provider/feature/booking_requests/widgets/active_filters_display_widget.dart';
import 'package:dusto_provider/feature/booking_requests/widgets/calendar_filter_bottom_sheet.dart';
import 'package:dusto_provider/feature/booking_requests/widgets/calender_header_widget.dart';
import 'package:dusto_provider/feature/booking_requests/widgets/calender_order_list_dialog_widget.dart';
import 'package:dusto_provider/feature/booking_requests/widgets/month_cell_order_count_widget.dart';
import 'package:dusto_provider/feature/booking_requests/widgets/time_cell_order_count_widget.dart';
...
class _CalendarOrderScreenState extends State<CalendarOrderScreen> {
                  ...
                  child: SfCalendar(
                    ...
                    onTap: (CalendarTapDetails details) {
                      if (details.targetElement ==
                        ...
                        if (controller.currentViewType ==
                            CalendarViewType.month) {
                          _showBookingsForDate(
                            context,
                            details.date!,
                            controller,
                            isForDate: true,
                        ...
                        if (details.appointments != null &&
                          ...
                          } else if (controller.currentViewType ==
                    ...
                    monthCellBuilder:
                        (BuildContext context, MonthCellDetails details) {
                          if (controller.currentViewType ==
                              CalendarViewType.month) {
                            int count = controller.getOrderCountForDate(
                              details.date,
                            );
  ...
  BookingCalendarDataSource _buildDataSource(
    BookingCalendarController controller,
  ) {
      ...
      for (var calenderData in calendarDataList) {
        if (calenderData.count > 0) {
          ...
          if (controller.currentViewType == CalendarViewType.week ||
            ...
            DateTime? fromDateTime = _addTimeString(
              calenderData.start,
              calenderData.startHourTime,
            );
            DateTime toDateTime = _addTimeString(
              calenderData.end,
              calenderData.endHourTime,
            );
  ...
  void _showBookingsForDate(
    ...
    showModalBottomSheet(
      ...
      builder: (context) {
        return CalenderOrderListDialogWidget(bookings: bookings);
      },
    );
  }
}
