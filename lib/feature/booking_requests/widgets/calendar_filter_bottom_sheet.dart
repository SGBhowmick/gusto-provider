...
class _CalendarFilterBottomSheetState extends State<CalendarFilterBottomSheet> {
  @override
  void initState() {
    Get.find<CalenderOrderFilterController>().initFilterState(
      Get.find<BookingCalendarController>().calendarData!,
    );
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      FilterSectionContainer(
                        ...
                        child: BookingStatusCheckboxesWidget(
...
class BookingTypeOptionsWidget extends StatelessWidget {
  ...
  const BookingTypeOptionsWidget({super.key, required this.controller});
...
class DateRangeSelectorWidget extends StatelessWidget {
  ...
  const DateRangeSelectorWidget({super.key, required this.controller});
...
class BookingStatusCheckboxesWidget extends StatelessWidget {
  ...
  const BookingStatusCheckboxesWidget({super.key, required this.controller});
    ...
    return Container(
      ...
      child: GridView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return CheckboxItemWidget(controller: controller, status: status);
        },
      ),
    );
  }
