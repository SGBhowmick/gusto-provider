...
class ActiveFiltersDisplayWidget extends StatelessWidget {
            ...
            child: SingleChildScrollView(
              ...
              child: Row(
                ...
                children: [
                  ...
                  if (calendarData.filterStartDate != null ||
                      calendarData.filterEndDate != null)
                    _FilterChip(
                      label: '${'date'.tr} : ',
                      value: DateConverter.formatDateRangeText(
                        startDate: calendarData.filterStartDate,
                        endDate: calendarData.filterEndDate,
                      ),
                      onClear: () => filterController.clearDateFilter(),
                    ),

                  // Booking Type Filter Chip
                  if (calendarData.bookingType != null &&
                      calendarData.bookingType != ServiceType.all)
                    _FilterChip(
                  ...
                  if (calendarData.bookingStatus != null)
                    ...calendarData.bookingStatus!.map((status) {
                      return _FilterChip(
                        ...
                        onClear: () =>
                            filterController.clearStatusFilter(status),
                      );
                    }),
                ],
              ),
  ...
  bool _hasActiveFilters(CalenderOrderModel calendarData) {
    return (calendarData.filterStartDate != null ||
            calendarData.filterEndDate != null) ||
        (calendarData.bookingType != null &&
            calendarData.bookingType != ServiceType.all) ||
        (calendarData.bookingStatus != null &&
            calendarData.bookingStatus!.isNotEmpty);
  }
}
...
class _FilterChip extends StatelessWidget {
  ...
  const _FilterChip({this.label, required this.value, required this.onClear});
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          ...
          BoxShadow(
            color: Theme.of(
              context,
            ).textTheme.bodyLarge!.color!.withValues(alpha: 0.04),
            blurRadius: 2,
