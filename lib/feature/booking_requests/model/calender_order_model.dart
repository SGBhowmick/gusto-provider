...
import 'package:dusto_provider/common/enums/enums.dart';

CalenderOrderModel calenderOrderModelFromJson(String str) =>
    CalenderOrderModel.fromJson(json.decode(str));

String calenderOrderModelToJson(CalenderOrderModel data) =>
...
class CalenderOrderModel {
  ...
  factory CalenderOrderModel.fromJson(Map<String, dynamic> json) =>
      CalenderOrderModel(
        dayGridMonth: json["dayGridMonth"] != null
            ? List<CalenderData>.from(
                json["dayGridMonth"].map((x) => CalenderData.fromJson(x)),
              )
            : null,
        timeGridWeek: json["timeGridWeek"] != null
            ? List<CalenderData>.from(
                json["timeGridWeek"].map((x) => CalenderData.fromJson(x)),
              )
            : null,
        timeGridDay: json["timeGridDay"] != null
            ? List<CalenderData>.from(
                json["timeGridDay"].map((x) => CalenderData.fromJson(x)),
              )
            : null,
        filterStartDate: json["filter_start_date"] != null
            ? DateTime.tryParse(json["filter_start_date"])
            : null,
        filterEndDate: json["filter_end_date"] != null
            ? DateTime.tryParse(json["filter_end_date"])
            : null,
        bookingType: json["booking_type"] != null
            ? ServiceTypeExtension.serviceTypeFromValue(json["booking_type"])
            : null,
        bookingStatus: json["booking_status"] != null
            ? List<BookingStatusEnum>.from(
                json["booking_status"]
                    .map((x) => BookingStatusEnumExtension.fromValue(x))
                    .where((x) => x != null),
              )
            : null,
      );
  ...
  Map<String, dynamic> toJson() => {
    "dayGridMonth": dayGridMonth != null
        ? List<dynamic>.from(dayGridMonth!.map((x) => x.toJson()))
        : null,
    "timeGridWeek": timeGridWeek != null
        ? List<dynamic>.from(timeGridWeek!.map((x) => x.toJson()))
        : null,
    "timeGridDay": timeGridDay != null
        ? List<dynamic>.from(timeGridDay!.map((x) => x.toJson()))
        : null,
    "filter_start_date": filterStartDate,
    "filter_end_date": filterEndDate,
    "booking_type": bookingType?.value,
    "booking_status": bookingStatus != null
        ? List<dynamic>.from(bookingStatus!.map((x) => x.value))
        : null,
  };
}
...
class CalenderData {
  ...
  factory CalenderData.fromJson(Map<String, dynamic> json) => CalenderData(
    ...
    bookings: List<CalenderBooking>.from(
      json["bookings"].map((x) => CalenderBooking.fromJson(x)),
    ),
  );
...
class CalenderBooking {
  ...
  factory CalenderBooking.fromJson(Map<String, dynamic> json) =>
      CalenderBooking(
        id: json["id"],
        ...
        totalBookingAmount:
            double.tryParse('${json["total_booking_amount"]}') ?? 0,
...
enum ServiceLocation { customer, provider }
