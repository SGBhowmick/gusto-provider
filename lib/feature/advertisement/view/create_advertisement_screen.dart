                          ...
                          advertisementController.selectedAdsType ==
                              ...
                              ? Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "${"maximum".tr} ${FileValidationHelper.formatFileSize(Get.find<SplashController>().configModel.content?.maxVideoUploadSize ?? 50)}",
                                      style: robotoRegular.copyWith(
                                        fontSize: 12,
                                    ...
                                    Text(
                                      "${"supports".tr} ${AppConstants.allowedVideoExtensions.join(', ').toUpperCase()}",
                                      style: robotoRegular.copyWith(
                                        fontSize: 12,
                                        color: Theme.of(context).hintColor,
                                      ),
