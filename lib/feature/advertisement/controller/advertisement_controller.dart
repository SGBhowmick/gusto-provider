...
class AdvertisementController extends GetxController
  ...
  Future<void> removeAdvertisementItemFromList(
  ...
  void pickProfileImage(bool isRemove) async {
    if (isRemove) {
      ...
      _networkProfileImage = null;
      _pickedProfileImage = await FileValidationHelper.validateAndPickImage(
  ...
  void pickCoverImage(bool isRemove) async {
    if (isRemove) {
      ...
      _networkCoverImage = null;
      _pickedCoverImage = await FileValidationHelper.validateAndPickImage(
        source: ImageSource.gallery,
      );
      if (_pickedCoverImage != null) {
        _isCoverImageValid = true;
  ...
  void pickVideoFile(bool isRemove) async {
    if (isRemove) {
      ...
      _networkVideoFile = null;
      _pickedVideoFile = await FileValidationHelper.validateAndPickVideo(
        source: ImageSource.gallery,
      );
      if (_pickedVideoFile != null) {
        _isVideoValid = true;
