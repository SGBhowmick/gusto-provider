                  ...
                  children: [
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            border: Border(
                              bottom: BorderSide(
                                color: signUpController.isZoneValid
                            ...
                            child: DropdownButton(
                              ...
                              hint: Text(
                                ...
                                style: robotoRegular.copyWith(
                                  ...
                                  fontSize:
                                      signUpController.selectedIdentityType ==
                                          ''
                              ...
                              items: signUpController.zoneList.map((
                                ZoneData zoneData,
                              ) {
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            border: Border(
                              bottom: BorderSide(
                                color: signUpController.isIdentityTypeValid
                                    ? Theme.of(context).hintColor
                                    : Theme.of(context).colorScheme.error,
                              ),
                            ),
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        signUpController.selectedIdentityImageList.length <
