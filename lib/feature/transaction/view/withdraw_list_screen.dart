import 'package:dusto_provider/feature/transaction/widget/withdraw_list_shimmer.dart';
                                          ...
                                          children: [
                                              ...
                                              children: [
                                                ...
                                                Container(
                                                  ...
                                                  decoration: BoxDecoration(
                                                    ...
                                                    color: context
                                                        .customThemeColors
                                                        .buttonTextColorMap[transactionsList[index]
                                                            .requestStatus]
                                                        ?.withValues(
                                                          alpha: 0.2,
                                                        ),
                                                  ...
                                                  child: Text(
                                                    "${transactionsList[index].requestStatus}"
                                                        .tr,
                                                    style: robotoMedium.copyWith(
                                                      fontSize: Dimensions
                                                          .fontSizeSmall,
                                            ...
                                            if (transactionsList[index]
                                              ...
                                              Row(
                                                children: [
                                                  Text(
                                                    '${transactionsList[index].requestStatus.toString().tr} ${'by'.tr} : ',
                                                    style: robotoRegular
                                                        .copyWith(
                                                          fontSize: Dimensions
                                                              .fontSizeDefault,
                                                  ...
                                                  Text(
                                                    '${transactionsList[index].requestUpdater!.firstName ?? ""} '
