import 'dart:convert';
import 'dart:math';
import 'package:dusto_provider/feature/payement_information/widgets/payment_info_card.dart';
import 'package:dusto_provider/feature/transaction/model/dropdown_method_method.dart';
                              ...
                              onChanged: (value) {
                                if (value?.type == MethodType.others) {
                                  _selectedMethodName = value!
                                      ...
                                      .methodName
                                      .toString();
                                  _selectedMethodId = value.withdrawalMethod!.id
                                      .toString();

                                  selectPaymentMethodField(
                                    value.withdrawalMethod!.id.toString(),
                                    value.withdrawalMethod!.methodName
                                        .toString(),
                                    transactionMoneyController,
                                  );
                                }
                                transactionMoneyController.onChangeMethod(
                                  value,
                                );
                              },
                            ),
