                                ...
                                builder: (transactionController) {
                                  return SizedBox(
                                    ...
                                    child: ListView.builder(
                                      itemCount: suggestInputAmountList.length,
                                      scrollDirection: Axis.horizontal,
                                      padding: EdgeInsets.zero,
                                      itemBuilder: (cnt, index) {
                                        return GestureDetector(
                                          onTap: () {
                                            transactionController.setIndex(
                                              index,
                                              suggestInputAmountList[index]
                                                  .toString(),
                                            );
                                            widget.inputAmountController!.text =
                                                suggestInputAmountList[index]
                                                    .toString();
                                          },
                                          child: Container(
