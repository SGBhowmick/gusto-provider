...
import 'package:dusto_provider/feature/subscriptions/model/subscription_transaction_model.dart';
import 'package:dusto_provider/util/dimensions.dart';
import 'package:dusto_provider/util/images.dart';
...
class SubscriptionInvoice {
  ...
  static pw.SpanningWidget buildSimpleText({
    String? title,
    String? subtitle,
  ...
  static pw.ConstrainedBox buildTitleText({
    String? title,
    String? subtitle,
    TextStyle? style,
