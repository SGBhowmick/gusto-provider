            ...
            children: [
                        ...
                        child: Column(
                          children: [
                            SwitchButton(
                              ...
                              onTap: (bool value) {
                                businessSettingController
                                    .toggleServiceAvailabilitySettings();
                              },
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  TimePickerWidget(
                                    title: 'open_time'.tr,
                                    time: businessSettingController
                                        .serviceStartTime,
                                    onTimeChanged: (time) {
                                      businessSettingController
                                              .setServiceStartTime =
                            ...
                            GridView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return InkWell(
                                  onTap: () => businessSettingController
                                      .toggleDaysCheckedValue(index),
                                  child: CustomCheckBox(
                                    title: businessSettingController
                                        .daysList[index],
                              ...
                              itemCount:
                                  businessSettingController.daysList.length,
                              shrinkWrap: true,
              ...
              CustomButton(
                ...
                onPressed: () {
                  ...
                  if (tutorialData?[AppConstants.serviceAvailabilityTutorialKey]
                          ?.contains('0') ??
                      true) {
                  ...
                  businessSettingController
                      .updateServiceAvailabilitySettingsIntoServer();
                },
