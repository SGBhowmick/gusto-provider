import 'package:dusto_provider/feature/profile/model/provider_model.dart';
import 'package:dusto_provider/feature/settings/business/controller/identity_controller.dart';
import 'package:dusto_provider/feature/settings/business/widget/identity_info_widget.dart';
import 'package:dusto_provider/feature/tutorial/controller/tutorial_controller.dart';
...
class _BusinessInfoTabItemWidgetState extends State<BusinessInfoTabItemWidget> {
  ...
  void initState() {
    ...
    Get.find<IdentityController>().onChangeIdentityType(
      providerInfo?.owner?.identificationType,
      isUpdate: false,
    );

    Get.find<IdentityController>().initializeCurrentImage(
      providerInfo?.owner?.identificationImageFullPath ?? [],
    );
                  ...
                  children: [
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    IgnorePointer(
                                      ignoring: userProfileController
                                          .keepPersonalInfoAsCompanyInfo,
                    ...
                    Padding(
                      ...
                      child: CustomButton(
                        ...
                        onPressed: () =>
                            _updateProfile(context, userProfileController),
                      ),
                    ),
        ...
        child: Stack(
          ...
          children: [
            userProfileController.pickedFile == null
                ...
                : CircleAvatar(
                    radius: Dimensions.paddingSizeExtraLarge * 2,
                    backgroundImage: FileImage(
                      File(userProfileController.pickedFile!.path),
                    ),
                  ),

            IconButton(
              onPressed: () => userProfileController.pickImage(),
  ...
  void _updateProfile(
    ...
    final IdentityController indicatorController =
    ...
    if ((userProfileController.coverImageFile?.path.isEmpty ?? true) &&
        (userProfileController
                .providerModel
                ?.content
                ?.providerInfo
    ...
    final isValidForm = userProfileController
        .profileInformationFormKey
        .currentState!
        .validate();
    ...
    if (!isValidForm || !isZoneValid) {
      if (userProfileController.companyNameController?.text.isEmpty ?? true) {
        ...
        _scrollToFocus(_companyNameFocus);
              ...
              true) ||
          FormValidationHelper().isValidPhone(
                userProfileController.countryDialCode +
                    userProfileController.companyPhoneController!.text,
              ) !=
              null) {
        _companyPhoneFocus.requestFocus();
        _scrollToFocus(_companyPhoneFocus);
      } else if ((userProfileController.companyEmailController?.text.isEmpty ??
              true) ||
          FormValidationHelper().isValidEmail(
                userProfileController.companyEmailController!.text,
              ) !=
              null) {
        ...
        _scrollToFocus(_contactPersonNameFocus);
          ...
          FormValidationHelper().isValidPhone(
                userProfileController.countryDialCode +
                    userProfileController.personalPhoneController!.text,
              ) !=
              null) {
        ...
        _scrollToFocus(_contactPersonPhoneFocus);
              ...
              true) ||
          FormValidationHelper().isValidEmail(
                userProfileController.personalEmailController!.text,
              ) !=
              null) {
    ...
    if (userProfileController.profileInformationFormKey.currentState!
            .validate() &&
...
class BasicInfoWidget extends StatelessWidget {
  ...
  }) : _companyNameFocus = companyNameFocus,
       _companyPhoneFocus = companyPhoneFocus,
       _companyEmailFocus = companyEmailFocus,
       _companyAddressFocus = companyAddressFocus;
              ...
              builder: (locationController) {
                return GestureDetector(
                  onTap: () async {
                    await Get.to(
                      () => PickMapScreen(
                        ...
                        initialAddress: userProfileController
                            .providerModel
                            ?.content
                            ?.providerInfo
                            ?.companyAddress,
                    ...
                    companyAddressController.text =
                        locationController.pickAddress.address != null &&
                  ...
                  child: CustomTextField(
                    ...
                    isEnabled:
                        Get.find<LocationController>().pickAddress.address != ""
                        ? true
                        : false,
                    suffixIcon: Images.pickPointLocation,
                    onPressedSuffix: () async {
                      final defaultLatLng = Get.find<SplashController>()
                          .configModel
                          .content
                          ?.defaultLocation
                          ?.defaultLocation;
            ...
            Container(
              ...
              child: DropdownButtonHideUnderline(
                child: DropdownButton(
                  ...
                  elevation: 8,
                  hint: Text(
                    userProfileController.selectedZoneName == ""
                        ? userProfileController.myZone
                        : userProfileController.selectedZoneName,
                    style: robotoRegular.copyWith(
                  ...
                  items: userProfileController.zoneList.map((
                    ZoneData zoneData,
                  ) {
                  ...
                  onChanged: (ZoneData? zoneData) {
                    userProfileController.setNewZoneValue(
                      zoneData!.name!,
                      zoneData.id!,
                    );
...
class LogoWidget extends StatelessWidget {
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: [
                    ...
                    if (_canEdit(userProfileController))
                      Positioned.fill(
                        child: Align(
  ...
  bool _canEdit(UserProfileController userProfileController) {
    return userProfileController.pickedFile != null ||
        (userProfileController
                .providerModel
                ?.content
                ?.providerInfo
...
class CoverImageWidget extends StatelessWidget {
                  ...
                  Positioned.fill(
                    child: ClipRRect(
                      ...
                      child: userProfileController.coverImageFile != null
                          ? Image.file(
                              File(userProfileController.coverImageFile!.path),
                            )
                          : CustomImage(
                              image:
                                  userProfileController
  ...
  bool _canEdit(UserProfileController userProfileController) {
    return userProfileController.coverImageFile != null ||
        (userProfileController
                .providerModel
                ?.content
                ?.providerInfo
