import 'package:dusto_provider/feature/dashboard/widgets/caash_in_hand_widget.dart';
  ...
  Widget build(BuildContext context) {
    return GetBuilder<UserProfileController>(
      builder: (userProfileController) {
        ...
        const Color brandColor = Color(0xFF07B89C);
        const Color brandCurveColor = Color(0xFF059A83);
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                TopCardItem(
                                  height: 130,
                                  cardColor: brandColor.withOpacity(0.5),
                                  curveColor: brandCurveColor,
                                  amount:
                                      dashboardController.dashboardTopCards !=
                                              null &&
