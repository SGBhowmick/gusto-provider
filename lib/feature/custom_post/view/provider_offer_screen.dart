...
import 'package:dusto_provider/feature/custom_post/model/post_model.dart';
                            ...
                            child: Column(
                              children: [
                                      ...
                                      Stack(
                                        ...
                                        children: [
                                          GestureDetector(
                                            onTap: () {
                                              postController
                                                  .changeVisibilityInfoWidgetStatus();
                                            },
                                            child: Icon(
                                              Icons.info_outline,
                                              size: 18,
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    "${widget.postData.customer?.firstName ?? ""} ${widget.postData.customer?.lastName ?? ""}",
                                    style: robotoMedium.copyWith(
                      ...
                      Row(
                        ...
                        children: [
                          ClipRRect(
                            ...
                            child: CustomImage(
                              image:
                                  "${widget.postData.service?.thumbnailFullPath}",
                              height: 40,
                              width: 40,
                            ),
                          ),
                      ...
                      ? CustomButton(
                          ...
                          onPressed: () {
                            ...
                            if (postController
                              ...
                              showCustomSnackBar(
                                "${'minimum_bidding_amount'.tr} ${PriceConverter.convertPrice(minBiddingAmount)}",
                              );
                            } else {
