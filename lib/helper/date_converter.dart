...
class DateConverter {
  ...
  static DateTime addTimeStringToDate(DateTime date, String? timeString) {
    ...
    try {
      ...
      if (hours < 0 || hours > 23) {
        throw FormatException(
          'Invalid hour value: $hours. Must be between 0 and 23',
        );
      }
      if (minutes < 0 || minutes > 59) {
        throw FormatException(
          'Invalid minute value: $minutes. Must be between 0 and 59',
        );
      }
      if (seconds < 0 || seconds > 59) {
        throw FormatException(
          'Invalid second value: $seconds. Must be between 0 and 59',
        );
      }
      ...
      throw FormatException(
        'Failed to parse time string "$timeString": ${e.message}',
      );
    }
  }
