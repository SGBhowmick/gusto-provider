import 'dart:io';
import 'package:dusto_provider/common/enums/enums.dart' hide FileType;
import 'package:dusto_provider/common/widgets/custom_snackbar.dart';
...
class FileValidationHelper {
  ...
  static Future<XFile?> validateAndPickVideo({
    ...
    try {
      ...
      // Step 2: Validate file extension
      final extensionError = validateVideoExtension(file: pickedVideo);
  ...
  /// Returns null if valid, otherwise returns error message
  static String? validateVideoExtension({required XFile file}) {
    try {
      // Try 1: Validate using MIME type (iOS/Web usually provides this)
